 ...
 * Note that until Andorid actually supports kotlin linting from the command line, this is not worth addressing:
 ...
 * > Task :app:lint
    ...
    at com.fbalashov.moduleEnforcer.DetectorRegistry.getIssues(DetectorRegistry.kt:12)
    at com.android.tools.lint.client.api.JarFileIssueRegistry.<init>(JarFileIssueRegistry.kt:53)
...
public class Issues {
  ...
  public static Issue ISSUE_MODULE_USAGE = Issue.create(
      "ModuleEnforcer_RequiredMethodNotCalled",
